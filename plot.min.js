...
window.Plot=Plot;function Plot(a,e){var b=a.getBoundingClientRect(),c=document.createElement("canvas");c.width=b.width;c.height=b.height;a.appendChild(c);for(var d in e)this[d]=e[d];this.applyDefaultSettings();this.bottomMargin=0;this.canvas=c;this.ctx=c.getContext("2d");this.height=c.height;this.width=c.width;c.style["background-color"]=this.backgroundColor;this.calculateDataRanges();this.calculateDrawingRanges();this.calculateDrawingProperties();this.scaleData()}
...
function toFixedDecimals(a,e){a+="";var b=a.toString().indexOf(".");if(-1==b)for(0<e&&(a+="."),b=0;b<e;b++)a+="0";else{var c=a.toString().length-(b+1);for(b=0;b<e-c;b++)a+="0"}return a}function fillWithDecimalZeros(a,e){a=a.toString();var b=-1==a.indexOf(".");if(b&&1==e)return a;b&&1<e&&(a+=".",e--);for(b=0;b<e;b++)a+="0";return a};
}).call(this)
