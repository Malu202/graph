...
Plot.prototype.generateCanvas=function(a){var e=window.devicePixelRatio||1,b=a.getBoundingClientRect(),c=document.createElement("canvas");this.height=b.height;this.width=b.width;c.width=b.width*e;c.height=b.height*e;this.ctx=c.getContext("2d");this.ctx.scale(e,e);a.style.position="relative";a.style.top="0px";a.style.left="0px";c.style.position="absolute";c.style.top="0px";c.style.left="0px";c.style.height="100%";c.style.width="100%";a.appendChild(c);this.canvas=c};
