...
window.Plot=Plot;function Plot(a,e){this.doWhenLoaded(function(){var b=this.generateCanvas(a),c;for(c in e)this[c]=e[c];this.applyDefaultSettings();this.bottomMargin=0;this.canvas=b;this.ctx=b.getContext("2d");this.height=b.height;this.width=b.width;b.style["background-color"]=this.backgroundColor;this.calculateDataRanges();this.calculateDrawingRanges();this.calculateDrawingProperties();this.scaleData()})}
Plot.prototype.generateCanvas=function(a){var e=a.getBoundingClientRect(),b=document.createElement("canvas");b.width=e.width;b.height=e.height;a.style.position="relative";a.style.top="0px";a.style.left="0px";b.style.position="absolute";b.style.top="0px";b.style.left="0px";a.appendChild(b);return b};
