...
window.Plot=Plot;function Plot(a,e){for(var b in e)this[b]=e[b];this.applyDefaultSettings();this.bottomMargin=0;this.canvas=a;this.ctx=a.getContext("2d");this.height=a.height;this.width=a.width;a.style["background-color"]=this.backgroundColor;this.calculateDataRanges();this.calculateDrawingRanges();this.calculateDrawingProperties();this.scaleData()}
