...
Plot.prototype.generateCanvas=function(a){var e=window.devicePixelRatio||1,b=a.getBoundingClientRect(),c=document.createElement("canvas");this.width=Math.round(b.width);this.height=Math.round(b.height);c.width=this.width*e;c.height=this.height*e;this.ctx=c.getContext("2d");this.ctx.scale(e,e);a.style.position="relative";a.style.overflow="hidden";a.style.top="0px";a.style.left="0px";c.style.position="absolute";c.style.top="0px";c.style.left="0px";c.style.height=this.height+"px";c.style.width=this.width+
...
function scaleCoordinates(a,e,b,c){for(var d=[],f=0;f<a.length;f++)d[f]=e*(a[f]-b)+c;return d}function scaleAndInvertCoordinates(a,e,b,c,d){for(var f=[],g=0;g<a.length;g++)f[g]=d-e*(a[g]-b)-c;return f}function drawTextWithHeight(a,e,b,c,d,f){c/=20;e/=c;b/=c;f.save();f.font="20px Arial, Helvetica, sans-serif";f.fillStyle=d;f.scale(c,c);f.textAlign="center";f.textBaseline="middle";f.fillText(a,e,b);f.restore()}
function drawGridLineX(a,e,b,c,d){d.beginPath();d.strokeStyle=a;d.lineWidth=1;d.moveTo(e,b);d.lineTo(e+c,b);d.stroke()}function drawGridLineY(a,e,b,c,d){d.beginPath();d.strokeStyle=a;d.lineWidth=1;d.moveTo(e,b);d.lineTo(e,b-c);d.stroke()}function drawDataPoints(a,e,b,c,d,f,g){for(var h=0;h<a.length;h++)drawDataPoint(a[h],e[h],b,c,d,f,g)}
