(function(){
'use strict';window.Gauge=Gauge;function Gauge(b,c,e,d,f,g,h,k){this.initialize(b,c,e,d,f,g,h,k);window.addEventListener("resize",function(b){console.log(this.min);this.initialize(this.div,this.prefix,this.value,this.suffix,this.min,this.max,this.background,this.textColor);this.setValue(e)}.bind(this))}
...
this.size;c=new Color(0,0,255);e=new Color(255,0,0);this.ctx.strokeStyle=c.mix(e,b).rgb();this.ctx.arc(this.width/2,this.height/2,.9*this.size/2,Math.PI-Math.PI/4,Math.PI/4-(1-b)*(Math.PI+Math.PI/2),!1);this.ctx.stroke()};Gauge.prototype.animateValue=function(b,c,e){this.doWhenLoaded(function(){this.currentValue=this.min;this.value=b;this.displayValue=c;this.animationTime=e;window.requestAnimationFrame(this.animation.bind(this))})};var a=!0;
