(function(){
'use strict';window.Gauge=Gauge;function Gauge(b,c,d,h,k,l,f){this.doWhenLoaded(function(){var g=b.getBoundingClientRect(),e=document.createElement("canvas");e.width=g.width;e.height=g.height;b.appendChild(e);if(null==d||""==d)d=c;this.height=e.height;this.width=e.width;this.size=this.height<this.width?this.height:this.width;this.min=h;this.max=k;this.ctx=e.getContext("2d");e.style["background-color"]=l;this.textColor=f})}
...
function Color(b,c,d){this.r=b;this.g=c;this.b=d;this.rgb=function(){return"rgb("+this.r+","+this.g+","+this.b+")"};this.mix=function(b,c){var d=this.r-c*(this.r-b.r),f=this.g-c*(this.g-b.g);b=this.b-c*(this.b-b.b);c=255/Math.max(d,f,b);return new Color(d*c,f*c,b*c)}}var loaded=!1;window.addEventListener("load",function(){loaded=!0});Gauge.prototype.doWhenLoaded=function(b){loaded?b.bind(this)():window.addEventListener("load",function(){b.bind(this)()}.bind(this))};
}).call(this)
