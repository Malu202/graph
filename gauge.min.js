(function(){
'use strict';window.Gauge=Gauge;function Gauge(b,c,d,f,g,h,e){c=b.getBoundingClientRect();d=document.createElement("canvas");d.width=c.width;d.height=c.height;b.appendChild(d);this.height=d.height;this.width=d.width;this.size=this.height<this.width?this.height:this.width;this.min=f;this.max=g;this.ctx=d.getContext("2d");d.style["background-color"]=h;this.textColor=e}
...
2,this.height/2,.9*this.size/2,Math.PI-Math.PI/4,Math.PI/4-(1-b)*(Math.PI+Math.PI/2),!1);this.ctx.stroke()};Gauge.prototype.animateValue=function(b,c,d){this.currentValue=this.min;this.value=b;this.displayValue=c;this.animationTime=d;window.requestAnimationFrame(this.animation.bind(this))};var a=!0;
