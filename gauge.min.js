(function(){
'use strict';window.Gauge=Gauge;function Gauge(b,c,d,e,g,h,k){this.doWhenLoaded(function(){var f=this.generateCanvas(b);if(null==d||""==d)d=c;this.height=f.height;this.width=f.width;this.size=this.height<this.width?this.height:this.width;this.min=e;this.max=g;this.ctx=f.getContext("2d");f.style["background-color"]=h;this.textColor=k})}
Gauge.prototype.generateCanvas=function(b){var c=window.devicePixelRatio||1,d=b.getBoundingClientRect(),e=document.createElement("canvas");e.width=d.width*c;e.height=d.height*c;console.log(c);e.getContext("2d").scale(1/c,1/c);b.style.position="relative";b.style.top="0px";b.style.left="0px";e.style.position="absolute";e.style.right="0px";e.style.top="0px";e.style.left="0px";e.style.bottom="0px";b.appendChild(e);return e};
