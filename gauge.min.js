...
Gauge.prototype.generateCanvas=function(b){var c=window.devicePixelRatio||1,d=b.getBoundingClientRect(),e=document.createElement("canvas");this.height=d.height;this.width=d.width;e.width=d.width*c;e.height=d.height*c;this.ctx=e.getContext("2d");this.ctx.scale(c,c);b.style.position="relative";b.style.top="0px";b.style.left="0px";e.style.position="absolute";e.style.top="0px";e.style.left="0px";e.style.height="100%";e.style.width="100%";b.appendChild(e);this.canvas=e};
