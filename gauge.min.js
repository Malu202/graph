(function(){
'use strict';window.Gauge=Gauge;function Gauge(b,c,d,f,g,h,e){this.height=b.height;this.width=b.width;this.min=f;this.max=g;this.ctx=b.getContext("2d");b.style["background-color"]=h;this.textColor=e}
